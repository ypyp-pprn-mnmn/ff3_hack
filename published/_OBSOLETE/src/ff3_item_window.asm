...
item_window_patch_len	= item_window_patch_end - item_window_patch_begin
	.BANK	$35
	.ORG	item_window_patch_begin
	.DS		item_window_patch_len	;initialize original region
	.LIST
	.ORG	$adaf
...
.finish:
	jsr dispatchBattleCommand_5	;$8026 => recalcParams
...
;[out] x : offset to put item's count
	cmp cachedItems,x
	bne .putToFree
	;there is same item,stack onto it
	inx
	tya
	clc
	adc cachedItems,x
